...
<details>
  ...
  Recreating visual stimuli perceived by the brain. This process leverages advanced computational models, such as deep learning, to decode and map neural activity into interpretable visual outputs. 

  
  **Useful Resources:**
  - We've Already worked on this topic and invite you to visit this [Github page](https://github.com/mehdi-zade/EEG-AI-Image_reconstruction).
    
</details>

<details>
  <summary>Saliency Map Reconstruction</summary>
  Saliency Map Reconstruction from EEG Signals involves decoding neural activity to identify regions of visual stimuli that capture attention. By mapping EEG data to saliency maps, researchers reveal which parts of an image the brain prioritizes during perception.

  
  **Useful Resources:**
  - We've Already worked on this topic and invite you to visit this [Github page](https://github.com/mehdi-zade/EEG-AI-Saliency).
...
**[Mehdi Abdollahzadeh](https://github.com/mehdi-zade)**
- [Connect on LinkedIn](https://www.linkedin.com/in/mahdi-abdollahzadeh-0b39a2203)
